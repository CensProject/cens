...
public class EmpleadoController {
	...
	public String verDetallesDelEmpleado(@PathVariable(value = "id") Long id,Map<String,Object> modelo,RedirectAttributes flash) {
		...
		modelo.put("titulo", "SecurityService del empleado " + empleado.getFirstName());
		return "ver";
	}
	...
	public String edit(@PathVariable Long id, Model model){
		model.addAttribute("empleado", empleadoService.findOne(id));
		return "form_edit";
	}


	@PostMapping("/form_edit/{id}")
	public String actualizarEmpleado(@PathVariable Long id, @ModelAttribute("empleado") Empleado empleado, Model model){
		Empleado existingEmpleado = empleadoService.findOne(id);
		...
		empleadoService.update(existingEmpleado);
		return "redirect:/listar";
	}
